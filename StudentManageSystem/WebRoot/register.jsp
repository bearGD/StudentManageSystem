	...
	<div class="student-login">
		...
		<div class="student-login-box">
			<div class="student-login-top">
				...
				<span class="on" onclick="window.location.href='register.jsp'">注册</span>
			</div>
			<div class="student-toggle">
				<div class="student-comin student-r ">
					<form action="register" method="POST">
						<li><input type="text" name="username" placeholder="用户名"></li>
						<li><input type="text" name="password" placeholder="密码"></li>
						<li><input class="reg" type="submit" value="注册"></li>
					</form>
				</div>
			</div>
		</div>
